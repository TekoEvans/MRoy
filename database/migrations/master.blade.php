                        ...
                        <div class="others-option">
                            ...
                            <div class="option-item">
                                ...
                                <ul class="navbar-nav" class="dropdown-menu">
                                    ...
                                    <li class="nav-item">
                                        <div class="cart-btn">
                                            ...
                                            <a href="{{ '/dashboard' }}" class="nav-link"> Mon compte
                                            </a>
                                ...
                                <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right">
                                    @auth
                                        <a href="{{ url('/dashboard') }}" class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Mon compte</a>
                                    @else
                            ...
                            <div class="row">
                                <div class="col-lg-7 col-md-12">
                                    <div class="offer_modal_left">
                                        <img style="height: 100px;" src="assets/img/logo.png" alt="logo">
