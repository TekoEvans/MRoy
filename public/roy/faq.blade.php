...
<!-- Mirrored from andit.co/projects/html/andshop/andshop_frontend/faq.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Apr 2023 19:38:46 GMT -->
<head>
  <meta charset="UTF-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <!-- Title -->
  <title>Faqs - AndShop</title>
  <!-- Bootstrap css -->
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="faqs_area_wrapper">
            <div class="accordion md-accordion" id="accordionExample" role="tablist" aria-multiselectable="true">
              <!-- Accordion card -->
              <div class="card_items_area">
                <!-- Card header -->
                <div class="card-header" role="tab" id="headingOne1">
                  <a class="collapsed" data-bs-toggle="collapse" href="#collapseOne1" aria-expanded="true"
                ...
                <!-- Card body -->
                <div id="collapseOne1" class="accordion-collapse collapse show" role="tabpanel"
              ...
              <div class="card_items_area">
                ...
                <div class="card-header" role="tab" id="headingTwo2">
                  <a class="collapsed" data-bs-toggle="collapse" href="#collapseTwo2" aria-expanded="false"
              ...
              <div class="card_items_area">
                ...
                <div class="card-header" role="tab" id="headingThree3">
                  <a class="collapsed" data-bs-toggle="collapse" href="#collapseThree3" aria-expanded="false"
                ...
                <!-- Card body -->
                <div id="collapseThree3" class="accordion-collapse collapse" role="tabpanel"
              ...
              <div class="card_items_area">
                ...
                <div class="card-header" role="tab" id="headingFour4">
                  <a class="collapsed" data-bs-toggle="collapse" href="#collapseFour4" aria-expanded="false"
                ...
                <!-- Card body -->
                <div id="collapseFour4" class="accordion-collapse collapse" role="tabpanel"
              ...
              <div class="card_items_area">
                ...
                <div class="card-header" id="headingFive5">
                  <a class="collapsed" data-bs-toggle="collapse" href="#collapseFive5" aria-expanded="false"
                ...
                <!-- Card body -->
                <div id="collapseFive5" class="accordion-collapse collapse" role="tabpanel"
