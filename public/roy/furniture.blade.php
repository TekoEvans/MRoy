...
<!-- Mirrored from andit.co/projects/html/andshop/andshop_frontend/furniture.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Apr 2023 19:32:59 GMT -->
<head>
    <meta charset="UTF-8" />
            ...
            <div class="row">
                <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                    <div class="furniture_bottom_wrapper">
                        <a href="shop-3.html" class="hover_effect_furniture">
                                ...
                                <div class="row">
                                        ...
                                        <div class="product_box text-center">
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="assets/img/furniture/product/1.jpg" alt="furniture_img1">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                                        <li><a href="wishlist.html" class="popup-ajax"><i
                                                                    class="far fa-heart"></i></a></li>
                                                        <li><a href="#!" class="action quickview"
                                            ...
                                            <div class="product_info">
                                                <h5 class="product_title"><a href="product-single-2.html">T-Shirt Form
                                                        Girls</a></h5>
                                    ...
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                        <div class="product_box text-center">
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="assets/img/furniture/product/2.jpg" alt="furniture_img1">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                                        <li><a href="wishlist.html" class="popup-ajax"><i
                                    ...
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                        <div class="product_box text-center">
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="assets/img/furniture/product/3.jpg" alt="furniture_img1">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                                        <li><a href="wishlist.html" class="popup-ajax"><i
                                    ...
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                        <div class="product_box text-center">
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="assets/img/furniture/product/4.jpg" alt="furniture_img1">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                                        <li><a href="wishlist.html" class="popup-ajax"><i
                                    ...
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                        <div class="product_box text-center">
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="assets/img/furniture/product/5.jpg" alt="furniture_img1">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                                        <li><a href="wishlist.html" class="popup-ajax"><i
                                    ...
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                        <div class="product_box text-center">
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="assets/img/furniture/product/6.jpg" alt="furniture_img1">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                                        <li><a href="wishlist.html" class="popup-ajax"><i
                                    ...
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                        <div class="product_box text-center">
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="assets/img/furniture/product/7.jpg" alt="furniture_img1">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                                        <li><a href="wishlist.html" class="popup-ajax"><i
                                    ...
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                        <div class="product_box text-center">
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="assets/img/furniture/product/8.jpg" alt="furniture_img1">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                                        <li><a href="wishlist.html" class="popup-ajax"><i
                ...
                <div class="col-lg-12">
                    <div class="furniture_popular_slider owl-carousel owl-them">
                        <div class="product_box text-center">
                            <div class="product_img">
                                <a href="shop-product-detail.html">
                                    <img src="assets/img/furniture/product/9.jpg" alt="furniture_img1">
                                </a>
                                <div class="product_action_box">
                                    <ul class="list_none pr_action_btn">
                        ...
                        <div class="product_box text-center">
                            <div class="product_img">
                                <a href="shop-product-detail.html">
                                    <img src="assets/img/furniture/product/10.jpg" alt="furniture_img1">
                                </a>
                                <div class="product_action_box">
                                    <ul class="list_none pr_action_btn">
                                        <li><a href="wishlist.html" class="popup-ajax"><i class="far fa-heart"></i></a>
                        ...
                        <div class="product_box text-center">
                            <div class="product_img">
                                <a href="shop-product-detail.html">
                                    <img src="assets/img/furniture/product/11.jpg" alt="furniture_img1">
                                </a>
                                <div class="product_action_box">
                                    <ul class="list_none pr_action_btn">
                                        <li><a href="wishlist.html" class="popup-ajax"><i class="far fa-heart"></i></a>
                        ...
                        <div class="product_box text-center">
                            <div class="product_img">
                                <a href="shop-product-detail.html">
                                    <img src="assets/img/furniture/product/12.jpg" alt="furniture_img1">
                                </a>
                                <div class="product_action_box">
                                    <ul class="list_none pr_action_btn">
                                        <li><a href="wishlist.html" class="popup-ajax"><i class="far fa-heart"></i></a>
                ...
                <div class="col-lg-8 offset-lg-2">
                    <div class="our_story_content">
                        ...
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed voluptatem quaerat
                            autem obcaecati nisi dolore reprehenderit fugiat accusamus repellat nihil possimus voluptas
                            ipsa,
                            asperiores maiores quisquam ipsum necessitatibus sit saepe.</p>
                        <a href="about-us.html" class="theme-btn-one bg-black btn_md">Read Full Story</a>
                    </div>
                </div>
            </div>
        </div>
...
<!-- Mirrored from andit.co/projects/html/andshop/andshop_frontend/furniture.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Apr 2023 19:33:35 GMT -->
</html>