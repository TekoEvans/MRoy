...
<!-- Mirrored from andit.co/projects/html/andshop/andshop_frontend/cart-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Apr 2023 19:37:25 GMT -->
<head>
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <!-- Title -->
    <title>Cart - AndShop</title>
    <!-- Bootstrap css -->
                    ...
                    <div class="coupon_code left">
                        ...
                        <div class="total_cart_inner">
                            ...
                            <form action="#!" id="total_cart_form_three">
                                <label class="custom_boxed">Free Shipping <span class="rigth_cart">$0.00</span>
                                    <input type="radio" name="radio">
                                    <span class="checkmark"></span>
                                </label>
                                <label class="custom_boxed">Standard <span class="rigth_cart">$30.00</span>
                                    <input type="radio" name="radio">
                                    <span class="checkmark"></span>
                                </label>
                                <label class="custom_boxed">Express <span class="rigth_cart">$20.00</span>
                                    <input type="radio" name="radio">
                                    <span class="checkmark"></span>
                                </label>
                                <h6 class="estimate_for_country">Estimate For Your Country</h6>
                            </form>
                            <div class="total_catr_three_bottom">
                                <h5>Total Cart <span class="rigth_cart">$50.00</span></h5>
                            </div>
                            <div class="cart_submit">
                                <a href="checkout.html" class="theme-btn-one btn-black-overlay btn_sm">Checkout</a>
                            </div>
                        </div>
                    </div>
