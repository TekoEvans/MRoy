...
<!-- Mirrored from andit.co/projects/html/andshop/andshop_frontend/cycle.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Apr 2023 19:35:44 GMT -->
<head>
    <meta charset="UTF-8" />
...
<body>
                        ...
                        <ul class="navbar-nav">
                            <li class="nav-item"><a href="#" class="nav-link active">Home <i
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item"><a href="electronics.html" class="nav-link">Electronics</a>
                                    </li>
                                    ...
                                    <li class="nav-item"><a href="baby-shop.html" class="nav-link">Baby Toys</a></li>
    ...
    <!-- Banner Area -->
    <section id="banner_cycle">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="banner_text_cycle">
                        <h1>Best <span>Bicycle Collection</span> In The World</h1>
                        <p>Officia cupidatat aliquip fugiat reprehenderit nulla aliqua esse voluptate. Nisi esse ex in non aliquip.</p>
                        <a href="shop-3.html" class="theme-btn-one bg-black btn_md">Shop Now</a>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="hero_img_cycle">
                        <img src="assets/img/cycle/common/cycle.png" alt="img" class="wow slideInRight" data-wow-duration="3.0s"
                            data-wow-delay=".3s">
                    </div>
                </div>
            </div>
    ...
    <!-- Hot Product Area -->
    <section id="hot_Product_area" class="section_padding_cycle_custom">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="tabs_center_button">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li role="presentation">
                                <a data-bs-toggle="tab" href="#!" data-bs-target="#new_arrival" role="tab" class="active">New Arrival</a>
                            </li>
                            <li role="presentation">
                                <a data-bs-toggle="tab" data-bs-target="#trending" role="tab" href="#!">Trending</a>
                            </li>
                            <li role="presentation">
                                <a data-bs-toggle="tab" data-bs-target="#best_sellers" href="#!">Best Sellers</a>
                            </li>
                            <li role="presentation">
                                <a data-bs-toggle="tab" data-bs-target="#featured" href="#!">Featured</a>
                            </li>
                            <li role="presentation">
                                <a data-bs-toggle="tab" data-bs-target="#on_sall" href="#!">On sall</a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="area_not_food"></div>
                <div class="col-lg-12">
                                ...
                                <div class="row">
                                        ...
                                        <div class="product_wrappers_one">
                                            <div class="thumb">
                                                <a href="product-single.html" class="image">
                                                    <img src="assets/img/cycle/product/pro-1.png" alt="Product" />
                                                    <img class="hover-image" src="assets/img/cycle/product/pro-8.png"
                                                        alt="Product" />
                                                </a>
                                                <span class="badges">
                                    ...
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                        <div class="product_wrappers_one">
                                            <div class="thumb">
                                                <a href="product-single.html" class="image">
                                                    <img src="assets/img/cycle/product/pro-2.png" alt="Product" />
                                                    <img class="hover-image" src="assets/img/cycle/product/pro-7.png"
                                                        alt="Product" />
                                                </a>
                                                <span class="badges">
                                                    <span class="new">New</span>
                                    ...
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                        <div class="product_wrappers_one">
                                            <div class="thumb">
                                                <a href="product-single.html" class="image">
                                                    <img src="assets/img/cycle/product/pro-3.png" alt="Product" />
                                                    <img class="hover-image" src="assets/img/cycle/product/pro-6.png"
                                                        alt="Product" />
                                                </a>
                                                <span class="badges">
                                    ...
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                        <div class="product_wrappers_one">
                                            <div class="thumb">
                                                <a href="product-single.html" class="image">
                                                    <img src="assets/img/cycle/product/pro-4.png" alt="Product" />
                                                    <img class="hover-image" src="assets/img/cycle/product/pro-5.png"
                                                        alt="Product" />
                                                </a>
                                                <span class="badges">
                                                    <span class="new">New</span>
                                    ...
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                        <div class="product_wrappers_one">
                                            <div class="thumb">
                                                <a href="product-single.html" class="image">
                                                    <img src="assets/img/cycle/product/pro-5.png" alt="Product" />
                                                    <img class="hover-image"
                                                        src="assets/img/cycle/product/pro-2.png" alt="Product" />
                                                </a>
                                                <span class="badges">
                                                    <span class="new">New</span>
                                                </span>
                                    ...
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                        <div class="product_wrappers_one">
                                            <div class="thumb">
                                                <a href="product-single.html" class="image">
                                                    <img src="assets/img/cycle/product/pro-6.png" alt="Product" />
                                                    <img class="hover-image"
                                                        src="assets/img/cycle/product/pro-1.png" alt="Product" />
                                                </a>
                                                <span class="badges">
                                                    <span class="hot">Hot</span>
                                                </span>
                                    ...
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                        <div class="product_wrappers_one">
                                            <div class="thumb">
                                                <a href="product-single.html" class="image">
                                                    <img src="assets/img/cycle/product/pro-7.png" alt="Product" />
                                                    <img class="hover-image"
                                                        src="assets/img/cycle/product/pro-3.png" alt="Product" />
                                                </a>
                                                <span class="badges">
                                                    <span class="new">New</span>
                                                </span>
                                    ...
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                        <div class="product_wrappers_one">
                                            <div class="thumb">
                                                <a href="product-single.html" class="image">
                                                    <img src="assets/img/cycle/product/pro-8.png" alt="Product" />
                                                    <img class="hover-image" src="assets/img/cycle/product/pro-1.png"
                                                        alt="Product" />
                                                </a>
                                                <span class="badges">
                                                    <span class="new">New</span>
    ...
    <!-- Offer Time Area -->
    <section id="offer_timer_cycle">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                    <div class="offer_time_flex_two">
                        ...
                        <div class="offer_timer_text_two">
                            <h5>Promotional Offer</h5>
                            <h2>All mountain bikes enjoy <span>35% Discount</span></h2>
                            <p>
                                Commodo sunt laboris non qui in id incididunt fugiat ipsum commodo. Consectetur tempor laboris.
                            </p>
                            <a href="shop-3.html" class="theme-btn-one bg-black btn_md">SHOP NOW</a>
                        </div>
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="offer_timer_two_img_cycle">
                        <img src="assets/img/cycle/common/cycle-1.png" alt="img">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="furniture_popular_product" class="ptb-100 slider_arrows_one">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="center_heading">
                        <h2>POPULAR PRODUCTS</h2>
                        <p>Officia cupidatat consectetur magna id excepteur veniam</p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="furniture_popular_slider owl-carousel owl-them">
                        <div class="product_box text-center">
                            <div class="product_img">
                                <a href="shop-product-detail.html">
                                    <img src="assets/img/cycle/product/pro-1.png" alt="img">
                                </a>
                                <div class="product_action_box">
                                    <ul class="list_none pr_action_btn">
                                        <li><a href="wishlist.html" class="popup-ajax"><i class="far fa-heart"></i></a>
                                        </li>
                                        <li><a href="#!" class="action quickview" data-link-action="quickview"
                                                title="Quick view" data-toggle="modal"
                                                data-target="#exampleModalCenter"> <i class="fas fa-expand"></i></a>
                                        </li>
                                        <li><a href="compare.html"><i class="fas fa-exchange-alt"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="product_info">
                                <h5 class="product_title"><a href="product-single-2.html">Dot Bike Classic-MR866</a></h5>
                                ...
                                <div class="add-to-cart">
                                    <a href="#offcanvas-add-cart" title="Add To Cart"
                                        class="offcanvas-toggle theme-btn-one bg-black btn_sm"><i
                                            class="fas fa-cart-arrow-down"></i> Add To Cart</a>
                                </div>
                            </div>
                        </div>
                        <div class="product_box text-center">
                            <div class="product_img">
                                <a href="shop-product-detail.html">
                                    <img src="assets/img/cycle/product/pro-2.png" alt="img">
                                </a>
                                <div class="product_action_box">
                                    <ul class="list_none pr_action_btn">
                                        <li><a href="wishlist.html" class="popup-ajax"><i class="far fa-heart"></i></a>
                        ...
                        <div class="product_box text-center">
                            <div class="product_img">
                                <a href="shop-product-detail.html">
                                    <img src="assets/img/cycle/product/pro-3.png" alt="img">
                                </a>
                                <div class="product_action_box">
                                    <ul class="list_none pr_action_btn">
                                        <li><a href="wishlist.html" class="popup-ajax"><i class="far fa-heart"></i></a>
                        ...
                        <div class="product_box text-center">
                            <div class="product_img">
                                <a href="shop-product-detail.html">
                                    <img src="assets/img/cycle/product/pro-4.png" alt="img">
                                </a>
                                <div class="product_action_box">
                                    <ul class="list_none pr_action_btn">
                                        <li><a href="wishlist.html" class="popup-ajax"><i class="far fa-heart"></i></a>
    ...
    <!-- NEW ARRIVAL -->
    <section id="new_arrival_area_cycle" class="pb-100">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="cycle_arrival_img_left">
                        <img src="assets/img/cycle/common/arrival-1.png" alt="img">
                    </div>
                </div>
                <div class="col-lg-4">
                  <div class="arrival_center_cycle_wrapper">
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <div class="cycle_arrival_item">
                                <img src="assets/img/cycle/product/arrival-1.png" alt="img">
                                <h4>Super helmet</h4>
                                <div class="arrival_price_cycle">
                                    <del>$300.00</del>
                                    <span>$300.00</span>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="cycle_arrival_item">
                                <img src="assets/img/cycle/product/arrival-2.png" alt="img">
                                <h4>Super helmet</h4>
                                <div class="arrival_price_cycle">
                                    <del>$300.00</del>
                                    <span>$300.00</span>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="cycle_arrival_item">
                                <img src="assets/img/cycle/product/arrival-3.png" alt="img">
                                <h4>Super helmet</h4>
                                <div class="arrival_price_cycle">
                                    <del>$300.00</del>
                                    <span>$300.00</span>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="cycle_arrival_item">
                                <img src="assets/img/cycle/product/arrival-4.png" alt="img">
                                <h4>Super helmet</h4>
                                <div class="arrival_price_cycle">
                                    <del>$300.00</del>
                                    <span>$300.00</span>
                ...
                <div class="col-lg-4">
                    <div class="cycle_arrival_img_left">
                        <img src="assets/img/cycle/common/arrival-2.png" alt="img">
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="instagram_post_slider owl-carousel owl-theme">
                        <div class="instgram_post">
                            <a href="#!">
                                ...
                                <img src="assets/img/cycle/insta/insta-1.png" alt="img" />
                            </a>
                        </div>
                        <div class="instgram_post">
                            <a href="#!">
                                <i class="fab fa-instagram"></i>
                                <img src="assets/img/cycle/insta/insta-2.png" alt="img" />
                            </a>
                        </div>
                        <div class="instgram_post">
                            <a href="#!">
                                <i class="fab fa-instagram"></i>
                                <img src="assets/img/cycle/insta/insta-3.png" alt="img" />
                            </a>
                        </div>
                        <div class="instgram_post">
                            <a href="#!">
                                <i class="fab fa-instagram"></i>
                                <img src="assets/img/cycle/insta/insta-4.png" alt="img" />
                            </a>
                        </div>
                        <div class="instgram_post">
                            <a href="#!">
                                <i class="fab fa-instagram"></i>
                                <img src="assets/img/cycle/insta/insta-5.png" alt="img" />
                            </a>
                        </div>
                        <div class="instgram_post">
                            <a href="#!">
...
<!-- Mirrored from andit.co/projects/html/andshop/andshop_frontend/cycle.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Apr 2023 19:36:05 GMT -->
</html>