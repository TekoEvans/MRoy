...
<!-- Mirrored from andit.co/projects/html/andshop/andshop_frontend/product-hover.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Apr 2023 19:37:26 GMT -->
<head>
  <meta charset="UTF-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <!-- Title -->
  <title>Product Hover - AndShop</title>
  <!-- Bootstrap css -->
...
<body>
      ...
      <div class="row align-items-center">
        <div class="col-lg-6 col-md-7">
          <ul class="top-header-contact-info">
            ...
            <li><i class="fas fa-street-view"></i> <a href="#" target="_blank">6890 Blvd, The Bronx, NY 1058, USA</a>
            </li>
          </ul>
        </div>
        ...
        <div class="col-lg-12">
          <div class="common_banner_text">
            ...
            <ul>
              ...
              <li class="active">Product Hover</li>
            </ul>
          </div>
        </div>
      </div>
  ...
  <!-- Product Hover One  -->
  <section class="product_hover_Widget ptb-100 bg-gray">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <div class="product_hover_heading">
            ...
            <div class="thumb">
              ...
              <div class="actions">
                ...
                <a href="#" class="action quickview" data-link-action="quickview" title="Quick view"
                  data-bs-toggle="modal" data-bs-target="#exampleModalCenter"><i class="fas fa-expand"></i></a>
  ...
  <!-- Product Hover Two  -->
  <section class="product_hover_Widget ptb-100">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <div class="product_hover_heading">
          ...
          <div class="product_item_two">
            <div class="product_item_inner">
              ...
              <div class="product_button">
                ...
                <a href="#" data-bs-toggle="modal" data-bs-target="#exampleModalCenter"><i class="fa fa-eye"></i></a>
              </div>
            </div>
  ...
  <section class="product_hover_Widget ptb-100 bg-gray">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <div class="product_hover_heading padd-bottom">
      ...
      <div class="row">
          ...
          <div class="product_box text-center">
            <div class="product_img">
              <a href="shop-product-detail.html">
                <img src="assets/img/product-image/product1.png" alt="furniture_img1">
              </a>
              <div class="product_action_box">
                <ul class="list_none pr_action_btn">
                  <li><a href="wishlist.html" class="popup-ajax"><i class="far fa-heart"></i></a></li>
                  <li><a href="#!" class="popup-ajax" data-bs-toggle="modal" data-bs-target="#exampleModalCenter"> <i
            ...
            <div class="product_info">
              <h5 class="product_title"><a href="product-single-2.html">T-Shirt Form Girls</a></h5>
              ...
              <div class="add-to-cart">
                <a href="#" class="theme-btn-one bg-black btn_sm" data-bs-toggle="modal"
                  data-bs-target="#shoppingCartModal"><i class="fas fa-cart-arrow-down"></i> Add To Cart</a>
              </div>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
          <div class="product_box text-center">
            <div class="product_img">
              <a href="shop-product-detail.html">
                <img src="assets/img/product-image/product2.png" alt="furniture_img1">
              </a>
              <div class="product_action_box">
                <ul class="list_none pr_action_btn">
                  <li><a href="wishlist.html" class="popup-ajax"><i class="far fa-heart"></i></a></li>
            ...
            <div class="product_info">
              <h5 class="product_title"><a href="product-single-2.html">White Black Line Dress</a></h5>
              <div class="product_price">
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
          <div class="product_box text-center">
            <div class="product_img">
              <a href="shop-product-detail.html">
                <img src="assets/img/product-image/product3.png" alt="furniture_img1">
              </a>
              <div class="product_action_box">
                <ul class="list_none pr_action_btn">
                  <li><a href="wishlist.html" class="popup-ajax"><i class="far fa-heart"></i></a></li>
            ...
            <div class="product_info">
              <h5 class="product_title"><a href="product-single-2.html">Blue Dress For Woman</a></h5>
              <div class="product_price">
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
          <div class="product_box text-center">
            <div class="product_img">
              <a href="shop-product-detail.html">
                <img src="assets/img/product-image/product4.png" alt="furniture_img1">
              </a>
              <div class="product_action_box">
                <ul class="list_none pr_action_btn">
                  <li><a href="wishlist.html" class="popup-ajax"><i class="far fa-heart"></i></a></li>
            ...
            <div class="product_info">
              <h5 class="product_title"><a href="product-single-2.html">Black T-Shirt For Woman</a></h5>
              <div class="product_price">
