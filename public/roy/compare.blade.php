...
<!-- Mirrored from andit.co/projects/html/andshop/andshop_frontend/compare.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Apr 2023 19:37:26 GMT -->
<head>
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <!-- Title -->
    <title>Compare - AndShop</title>
    <!-- Bootstrap css -->
                            ...
                            <table class="table">
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="product-image-title">
                                            <a href="product-single.html" class="image">
                                                <img src="assets/img/product-image/product1.png" alt="Compare Product">
                                            </a>
                                            <a href="shop-left-sidebar.html" class="category">Furniture</a>
                                            <h5> <a href="shop-left-sidebar.html" class="title">T-Shirt Form Girls</a>
                                            </h5>
                                        </td>
                                        <td class="product-image-title">
                                            <a href="product-single.html" class="image"><img
                                                    src="assets/img/product-image/product2.png"
                                                    alt="Compare Product"></a>
                                            <a href="shop-left-sidebar.html" class="category">Furniture</a>
                                            <h5><a href="shop-left-sidebar.html" class="title">White Black Line
                                                    Dress</a></h5>
                                        </td>
                                        <td class="product-image-title">
                                            <a href="product-single.html" class="image"><img
                                                    src="assets/img/product-image/product3.png"
                                                    alt="Compare Product"></a>
                                            <a href="shop-left-sidebar.html" class="category">Furniture</a>
                                            <h5><a href="shop-left-sidebar.html" class="title">Blue Dress For Woman</a>
                                            </h5>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="pro-addtocart"><a href="cart.html"
                                                class="theme-btn-one btn-black-overlay btn_sm"><span>ADD TO
                                                    CART</span></a></td>
                                        <td class="pro-addtocart"><a href="cart.html"
                                                class="theme-btn-one btn-black-overlay btn_sm"><span>ADD TO
                                                    CART</span></a></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="pro-remove"><button><i class="far fa-trash-alt"></i></button></td>
                                        <td class="pro-remove"><button><i class="far fa-trash-alt"></i></button></td>
                                        <td class="pro-remove"><button><i class="far fa-trash-alt"></i></button></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="pro-ratting">
                                            <div class="product-review">
                                                ...
                                                <span class="review-fill"><i class="far fa-star"></i></span>
                                                <span class="review-fill"><i class="far fa-star"></i></span>
                                                <span class="review-empty"><i class="far fa-star"></i></span>
                                            </div>
                                        </td>
                                        <td class="pro-ratting">
                                            <div class="product-review">
