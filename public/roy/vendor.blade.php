...
<!-- Mirrored from andit.co/projects/html/andshop/andshop_frontend/vendor.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Apr 2023 19:38:42 GMT -->
<head>
    <meta charset="UTF-8">
                    ...
                    <div class="dashboard_tab_button">
                        <ul role="tablist" class="nav flex-column dashboard-list">
                            ...
                            <li> <a href="#!" data-bs-toggle="tab" data-bs-target="#all_product"><i
                                        class="fas fa-shopping-cart"></i>Product</a></li>
                            <li><a href="#!" data-bs-toggle="tab" data-bs-target="#all_order"><i
                                        class="fas fa-shopping-bag"></i>Order</a></li>
                            <li><a href="#!" data-bs-toggle="tab" data-bs-target="#profile_vendor"><i
                                        class="far fa-id-badge"></i>Profile</a></li>
                            <li><a href="add-product.html"><i class="fas fa-cart-plus"></i>Add PRoduct</a></li>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="vendor_order_boxed">
                                        ...
                                        <div class="btn_right_table">
                                            <a href="add-product.html" class="theme-btn-one bg-black btn_sm">Add
                                                Product</a>
                                        </div>
                                    </div>
                                </div>
...
<!-- Mirrored from andit.co/projects/html/andshop/andshop_frontend/vendor.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Apr 2023 19:38:46 GMT -->
</html>