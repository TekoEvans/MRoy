...
<!-- Mirrored from andit.co/projects/html/andshop/andshop_frontend/blog-gride-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Apr 2023 19:38:32 GMT -->
<head>
  <meta charset="UTF-8" />
      ...
      <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
          <div class="blog_one_item img-zoom-hover">
            ...
            <div class="blog_text">
              <h5 class="date_area">
                <a href="blog-single.html">24 February 2021</a>
              </h5>
              <h4 class="heading">
                <a href="blog-single.html">This Designer Bronzer Has Even The Drugstore-Beauty-Buyers
                  Splurging!</a>
              </h4>
              <p class="para">
                Today kicks off early access to the Sephora Spring Sales Event
                so I wanted to share some of my top recent beauty buys I’ve
                been
              </p>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
          <div class="blog_one_item img-zoom-hover">
            ...
            <div class="blog_text">
              <h5 class="date_area">
                <a href="blog-single.html">29 jan 2018</a>
              </h5>
              <h4 class="heading">
                <a href="blog-single.html">4 Fresh Ways To Style Leather Shorts For Spring</a>
              </h4>
              <p class="para">
                We spent spring break this year in California with Cody’s
                family and it was such a fun getaway. Cody’s family always
                goes hard on vacation
              </p>
              <a href="blog-single.html" class="button">Read More<i class="fas fa-arrow-right"></i></a>
            </div>
          </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
          <div class="blog_one_item img-zoom-hover">
            ...
            <div class="blog_text">
              <h5 class="date_area">
                <a href="blog-single.html">21 February 2019</a>
              </h5>
              <h4 class="heading">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
          <div class="blog_one_item img-zoom-hover">
            ...
            <div class="blog_text">
              ...
              <h4 class="heading">
                <a href="blog-single.html">This Designer Bronzer Has Even Buyers Splurging!</a>
              </h4>
              <p class="para">
                Today kicks off early access to the Sephora Spring Sales Event
                so I wanted to share some of my top recent beauty buys
              </p>
              <a href="blog-single.html" class="button">Read More<i class="fas fa-arrow-right"></i></a>
            </div>
          </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
          <div class="blog_one_item img-zoom-hover">
            ...
            <div class="blog_text">
              ...
              <h4 class="heading">
                <a href="blog-single.html">4 Tips for A Colorful Easter Tablescape</a>
              </h4>
              <p class="para">
                Spring is all about the colors! Especially after what feels
                like an endless winter, I catch myself craving more color than
                usual.
              </p>
              <a href="blog-single.html" class="button">Read More<i class="fas fa-arrow-right"></i></a>
            </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
          <div class="blog_one_item img-zoom-hover">
            ...
            <div class="blog_text">
              ...
              <h4 class="heading">
                <a href="blog-single.html">Hawaii Couples Trip Guide and Spring Break Faves</a>
              </h4>
              <p class="para">
                After every trip to Hawaii, I always have a few DMs asking
                where we stayed, our favorite beaches, etc. Especially with
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
          <div class="blog_one_item img-zoom-hover">
            ...
            <div class="blog_text">
              ...
              <h4 class="heading">
                <a href="blog-single.html">If You Struggle To Hit Your Goals, Try This Instead</a>
              </h4>
              <p class="para">
                This year, instead of setting grand, lofty goals and New Years
                Resolutions, I realized that I respond better to smaller
                targets that I can cross
              </p>
              <a href="blog-single.html" class="button">Read More<i class="fas fa-arrow-right"></i></a>
            </div>
          </div>
