...
<!-- Mirrored from andit.co/projects/html/andshop/andshop_frontend/home-appliance.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Apr 2023 19:37:00 GMT -->
<head>
  <meta charset="UTF-8" />
...
<body>
  ...
  <!-- Banner Area -->
  <section id="banner_applicetion_home">
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="banner_applicetion_img">
           <a href="shop-2.html"><img src="assets/img/home-appliance/common/banner-1.png" alt="img"></a>
          </div>
        </div>
        <div class="col-lg-6">
          <div class="banner_applicetion_img">
           <a href="shop-2.html"><img src="assets/img/home-appliance/common/banner-2.png" alt="img"></a> 
          </div>
          <div class="banner_applicetion_img pt-4">
            <a href="shop-2.html"><img src="assets/img/home-appliance/common/banner-3.png" alt="img"></a> 
          </div>
        </div>
      </div>
    </div>
  ...
  <!-- Category Area -->
  <section id="category_area_car" class="ptb-100">
    <div class="container">
  ...
  <!-- Category Area -->
  <section id="offer_area_car" class="pb-100">
    <div class="container">
      <div class="row">
        <div class="col-lg-4 col-md-6 col-sm-12 col-12">
          <div class="car_offers_banner">
            <img src="assets/img/home-appliance/common/cat-1.png" alt="img">
            <div class="home_applicance_top_catagory">
              <h3>World’s Best <br> RO Water Purifiers</h3>
              <a href="shop-3.html">Shop now</a>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-6 col-sm-12 col-12">
          <div class="car_offers_banner">
            <img src="assets/img/home-appliance/common/cat-2.png" alt="img">
            <div class="home_applicance_top_catagory">
              <h3>Smart Kitchen <br> Appliances</h3>
              <a href="shop-3.html">Shop now</a>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-6 col-sm-12 col-12">
          <div class="car_offers_banner">
            <img src="assets/img/home-appliance/common/cat-3.png" alt="img">
            <div class="home_applicance_top_catagory">
              <h3>Electric Kettles <br> RO Water Purifiers</h3>
              <a href="shop-3.html">Shop now</a>
            </div>
          </div>
        </div>
   ...
   <section id="electronics_top_product" class="pb-100">
    <div class="container">
        <div class="row">
          <div class="col-lg-6">
            <div class="car_area_main_heading">
              <h2><span>Refrigerators</span> & Freezers</h2>
            </div>
          </div>
            <div class="col-lg-6">
                <div class="tabs_right_button">
                    <ul class="nav nav-tabs">
                        <li><a data-bs-toggle="tab" data-bs-target="#all" href="#!" class="active">All</a></li>
                        <li><a data-bs-toggle="tab" data-bs-target="#audio" href="#!">Audio & Home</a></li>
                        <li><a data-bs-toggle="tab" data-bs-target="#camera" href="#!">Camera & Photo</a></li>
                        <li><a data-bs-toggle="tab" data-bs-target="#home" href="#!">Home & Garden</a></li>
                    </ul>
                </div>
            </div>
        </div>
                                        ...
                                        <div class="product_item_inner">
                                            <div class="product_img_wrap">
                                                <a href="shop-left-sidebar.html">
                                                    <img src="assets/img/electronics/product/1.jpg"
                                                        alt="product_img">
                                                </a>
                                            </div>
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                    <div class="product_item_two">
                                        <div class="product_item_inner">
                                            <div class="product_img_wrap">
                                                <a href="shop-left-sidebar.html">
                                                    <img src="assets/img/electronics/product/2.jpg"
                                                        alt="product_img">
                                                </a>
                                            </div>
                                            <div class="product_button">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                    <div class="product_item_two">
                                        <div class="product_item_inner">
                                            <div class="product_img_wrap">
                                                <a href="shop-left-sidebar.html">
                                                    <img src="assets/img/electronics/product/3.jpg"
                                                        alt="product_img">
                                                </a>
                                            </div>
                                            <div class="product_button">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                    <div class="product_item_two">
                                        <div class="product_item_inner">
                                            <div class="product_img_wrap">
                                                <a href="shop-left-sidebar.html">
                                                    <img src="assets/img/electronics/product/4.jpg"
                                                        alt="product_img">
                                                </a>
                                            </div>
                                            <div class="product_button">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                    <div class="product_item_two">
                                        <div class="product_item_inner">
                                            <div class="product_img_wrap">
                                                <a href="shop-left-sidebar.html">
                                                    <img src="assets/img/electronics/product/5.jpg"
                                                        alt="product_img">
                                                </a>
                                            </div>
                                            <div class="product_button">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                    <div class="product_item_two">
                                        <div class="product_item_inner">
                                            <div class="product_img_wrap">
                                                <a href="shop-left-sidebar.html">
                                                    <img src="assets/img/electronics/product/6.jpg"
                                                        alt="product_img">
                                                </a>
                                            </div>
                                            <div class="product_button">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                    <div class="product_item_two">
                                        <div class="product_item_inner">
                                            <div class="product_img_wrap">
                                                <a href="shop-left-sidebar.html">
                                                    <img src="assets/img/electronics/product/7.jpg"
                                                        alt="product_img">
                                                </a>
                                            </div>
                                            <div class="product_button">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                    <div class="product_item_two">
                                        <div class="product_item_inner">
                                            <div class="product_img_wrap">
                                                <a href="shop-left-sidebar.html">
                                                    <img src="assets/img/electronics/product/8.jpg"
                                                        alt="product_img">
                                                </a>
                                            </div>
                                            <div class="product_button">
  ...
  <section id="elce_weekly_deal" class="pb-100 slider_arrows_one">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <div class="car_area_main_heading">
          ...
          <div class="elce_weekly_slider owl-theme owl-carousel">
            <div class="product_item_two">
              <div class="product_item_inner">
                <div class="product_img_wrap">
                  <a href="shop-left-sidebar.html">
                    <img src="assets/img/car/product/pro-1.png" alt="product_img">
                  </a>
                </div>
                <div class="product_button">
                  <a href="cart.html"><i class="fa fa-shopping-bag"></i></a>
                  ...
                  <a href="#" class="action quickview" data-link-action="quickview" title="Quick view"
                    data-bs-toggle="modal" data-bs-target="#exampleModalCenter"><i class="fa fa-eye"></i></a>
                </div>
              </div>
              <div class="product_detail">
                <h5 class="product_title">
            ...
            <div class="product_item_two">
              <div class="product_item_inner">
                <div class="product_img_wrap">
                  <a href="shop-left-sidebar.html">
                    <img src="assets/img/car/product/pro-2.png" alt="product_img">
                  </a>
                </div>
                <div class="product_button">
                  <a href="cart.html"><i class="fa fa-shopping-bag"></i></a>
            ...
            <div class="product_item_two">
              <div class="product_item_inner">
                <div class="product_img_wrap">
                  <a href="shop-left-sidebar.html">
                    <img src="assets/img/car/product/pro-3.png" alt="product_img">
                  </a>
                </div>
                <div class="product_button">
                  <a href="cart.html"><i class="fa fa-shopping-bag"></i></a>
            ...
            <div class="product_item_two">
              <div class="product_item_inner">
                <div class="product_img_wrap">
                  <a href="shop-left-sidebar.html">
                    <img src="assets/img/car/product/pro-4.png" alt="product_img">
                  </a>
                </div>
                <div class="product_button">
                  <a href="cart.html"><i class="fa fa-shopping-bag"></i></a>
  ...
  <!-- middel Banner Area  -->
  <section id="middal_car_banner_full" class="pb-100">
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="car_full_img_banner">
            <a href="shop-3.html"><img src="assets/img/home-appliance/common/banner_middel-1.png" alt="img"></a>
          </div>
        </div>
        <div class="col-lg-6">
          <div class="car_full_img_banner">
            <a href="shop-3.html"><img src="assets/img/home-appliance/common/banner_middel-2.png" alt="img"></a>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row mbn-30">
            ...
            <div class="col-md-4">
                <div class="banner-item mb-30">
                    <div class="banner-thumb">
                        <a href="shop-3.html">
                            <img src="assets/img/home-appliance/common/add-1.png" alt="">
                        </a>
                        <div class="banner_statistics_content">
                          <h3>Top Trending</h3>
                          <a href="shop-2.html">discover now</a>
                        </div>
                      </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
              <div class="banner-item mb-30">
                  <div class="banner-thumb">
                      <a href="shop-3.html">
                          <img src="assets/img/home-appliance/common/add-2.png" alt="">
                      </a>
                      <div class="banner_statistics_content">
                        <h3>Top Trending</h3>
                        <a href="shop-2.html">discover now</a>
          ...
          <div class="col-md-4">
            <div class="banner-item mb-30">
                <div class="banner-thumb">
                    <a href="shop-3.html">
                        <img src="assets/img/home-appliance/common/add-3.png" alt="">
                    </a>
                    <div class="banner_statistics_content">
                      <h3>Top Trending</h3>
                      <a href="shop-2.html">discover now</a>
  ...
  <!-- FEATURED PRODUCTS Area -->
  <section id="new_arrival_home_application" class="ptb-100 slider_arrows_one">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <div class="car_area_main_heading">
...
<!-- Mirrored from andit.co/projects/html/andshop/andshop_frontend/home-appliance.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Apr 2023 19:37:14 GMT -->
</html>