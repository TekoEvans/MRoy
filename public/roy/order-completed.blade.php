...
<!-- Mirrored from andit.co/projects/html/andshop/andshop_frontend/order-completed.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Apr 2023 19:37:26 GMT -->
<head>
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <!-- Title -->
    <title>Order Completed - AndShop</title>
    <!-- Bootstrap css -->
            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="text-center order_complete">
                        ...
                        <a href="shop-left-sidebar.html" class="theme-btn-one bg-black btn_sm">Continue Shopping</a>
                    </div>
                </div>
            </div>
        </div>
