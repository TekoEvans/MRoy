...
<!-- Mirrored from andit.co/projects/html/andshop/andshop_frontend/empty-cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Apr 2023 19:37:25 GMT -->
<head>
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <!-- Title -->
    <title>Empty - AndShop</title>
    <!-- Bootstrap css -->
            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3 col-md-6 offset-md-3 col-sm-12 col-12">
                    <div class="empaty_cart_area">
                        <img src="assets/img/common/empty-cart.png" alt="img">
                        <h2>YOUR CART IS EMPTY</h2>
                        <h3>Sorry Mate... No Item Found Inside Your Cart!</h3>
                        <a href="shop.html" class="btn btn-black-overlay btn_md">Continue Shopping</a>
                    </div>
                </div>
            </div>
        </div>
...
<!-- Mirrored from andit.co/projects/html/andshop/andshop_frontend/empty-cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Apr 2023 19:37:26 GMT -->
</html>