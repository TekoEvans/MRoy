...
<!-- Mirrored from andit.co/projects/html/andshop/andshop_frontend/invoice-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Apr 2023 19:38:01 GMT -->
<head>
  <meta charset="UTF-8">
          ...
          <div class="invoice-wrapper">
            <div class="invoice-header">
              <div class="upper-icon">
                <img src="assets/img/invoice/invoice.svg" class="img-fluid" alt="">
              </div>
              <div class="row header-content">
                <div class="col-md-6">
                  ...
                  <div class="mt-md-4 mt-3">
                    ...
                    <h4 class="mb-0">support@Andshop.com</h4>
                  </div>
                </div>
            ...
            <div class="invoice-footer text-right">
              <div class="authorise-sign">
                <img src="assets/img/invoice/sign.png" class="img-fluid" alt="sing">
                <span class="line"></span>
                <h6>Authorised Sign</h6>
              </div>
              <div class="buttons">
                <a href="#" class="theme-btn-one btn-black-overlay btn_sm" onclick="window.print();">export as PDF</a>
...
<!-- Mirrored from andit.co/projects/html/andshop/andshop_frontend/invoice-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Apr 2023 19:38:03 GMT -->
</html>