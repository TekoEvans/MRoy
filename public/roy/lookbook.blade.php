...
<!-- Mirrored from andit.co/projects/html/andshop/andshop_frontend/lookbook.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Apr 2023 19:37:59 GMT -->
<head>
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <!-- Title -->
    <title>LookBook - AndShop</title>
    <!-- Bootstrap css -->
...
<body>
    ...
    <!-- LookBook Area -->
    <section id="lookbook_area" class="lookbook pt-100">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="lookbook-block">
                        <div class="img-width">
                            <img src="assets/img/common/lookbook.jpg" class="img-fluid bg-img" alt="img">
                        </div>
                        <div class="lookbook-dot"><span>1</span>
                            <a href="#">
                                <div class="dot-showbox"><img src="assets/img/product-image/product1.png"
                        ...
                        <div class="lookbook-dot dot2"><span>2</span>
                            <a href="#">
                                <div class="dot-showbox"><img src="assets/img/product-image/product2.png"
                                        class="img-fluid blur-up lazyload " alt="">
                                    <div class="dot-info">
                                        <h5 class="title">tee</h5>
                                        <h5>200$</h5>
                ...
                <div class="col-lg-6">
                    <div class="lookbook-block">
                        <div class="img-width">
                            <img src="assets/img/common/lookbook2.jpg" class="img-fluid bg-img" alt="img">
                        </div>
                        <div class="lookbook-dot dot3"><span>1</span>
                            <a href="#">
                                <div class="dot-showbox"><img src="assets/img/product-image/product3.png"
                                        class="img-fluid blur-up lazyload" alt="">
                                    <div class="dot-info">
                                        <h5 class="title">tee</h5>
                                        <h5>200$</h5>
                        ...
                        <div class="lookbook-dot dot4"><span>2</span>
                            <a href="#">
                                <div class="dot-showbox"><img src="assets/img/product-image/product4.png"
                                        class="img-fluid blur-up lazyload " alt="">
                                    <div class="dot-info">
                                        <h5 class="title">tee</h5>
                                        <h5>200$</h5>
...
<!-- Mirrored from andit.co/projects/html/andshop/andshop_frontend/lookbook.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Apr 2023 19:38:01 GMT -->
</html>