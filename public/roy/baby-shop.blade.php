...
<!-- Mirrored from andit.co/projects/html/andshop/andshop_frontend/baby-shop.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Apr 2023 19:35:07 GMT -->
<head>
  <meta charset="UTF-8" />
...
<body>
  ...
  <div class="navbar-area">
    ...
    <div class="drodo-nav  drodo-nav-bg">
      <div class="container">
            ...
            <ul class="navbar-nav">
              <li class="nav-item"><a href="#" class="nav-link active">Home <i class='fas fa-chevron-down'></i></a>
                <ul class="dropdown-menu">
                  ...
                  <li class="nav-item"><a href="grocery.html" class="nav-link">Grocery</a></li>
                  <li class="nav-item"><a href="pharmacy.html" class="nav-link">Pharmacy</a></li>
                  <li class="nav-item"><a href="jewellary.html" class="nav-link">Jewellary</a></li>
                  <li class="nav-item"><a href="baby-shop.html" class="nav-link active">Baby Toys</a></li>
                  <li class="nav-item"><a href="cycle.html" class="nav-link">Cycle</a></li>
                  <li class="nav-item"><a href="sports.html" class="nav-link">Sports</a></li>
                  <li class="nav-item"><a href="car.html" class="nav-link">Motor Parts</a></li>
                  <li class="nav-item"><a href="home-appliance.html" class="nav-link">Home Appliance</a></li>
                </ul>
              </li>
  ...
  <div id="baby_banner">
    <div class="container">
      <div class="row">
        <div class="col-lg-8">
          <div class="baby_banner_img">
            <a href="shop-right-sidebar.html">
              <img src="assets/img/baby-shop/banner/banner-1.png" alt="img">
            </a>
          </div>
        </div>
        <div class="col-lg-4">
          <div class="row">
            <div class="col-lg-12 col-md-6 col-sm-6 col-12">
              <div class="baby_banner_img banner_last_img">
                <a href="shop-left-sidebar.html">
                  <img src="assets/img/baby-shop/banner/banner-2.png" alt="img">
                </a>
              </div>
            </div>
            <div class="col-lg-12 col-md-6 col-sm-6 col-12">
              <div class="baby_banner_img banner_last_img">
                <a href="shop-left-sidebar.html">
                  <img src="assets/img/baby-shop/banner/banner-3.png" alt="img">
                </a>
              </div>
            </div>
          </div>
  ...
  <!-- Shop Categories -->
  <section id="baby_shop_categories" class="pb-100">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <div class="jewellary_heading">
      ...
      <div class="row">
        <div class="col-lg-2 col-md-3 col-sm-4 col-6">
          <div class="baby_category_card">
            <a href="shop.html">
              <div class="baby_cat_img">
                <img src="assets/img/baby-shop/product/cat-1.png" alt="img">
              </div>
              <div class="baby_cat_content">
                <h5>Girls dress</h5>
                <p>20 Items</p>
              </div>
            </a>
        ...
        <div class="col-lg-2 col-md-3 col-sm-4 col-6">
          <div class="baby_category_card">
            <a href="shop.html">
              <div class="baby_cat_img">
                <img src="assets/img/baby-shop/product/cat-2.png" alt="img">
              </div>
              <div class="baby_cat_content">
                <h5>Boy,s dress</h5>
                <p>34 Items</p>
        ...
        <div class="col-lg-2 col-md-3 col-sm-4 col-6">
          <div class="baby_category_card">
            <a href="shop.html">
              <div class="baby_cat_img">
                <img src="assets/img/baby-shop/product/cat-3.png" alt="img">
              </div>
              <div class="baby_cat_content">
                <h5>Baby hat</h5>
                <p>10 Items</p>
        ...
        <div class="col-lg-2 col-md-3 col-sm-4 col-6">
          <div class="baby_category_card">
            <a href="shop.html">
              <div class="baby_cat_img">
                <img src="assets/img/baby-shop/product/cat-4.png" alt="img">
              </div>
              <div class="baby_cat_content">
                <h5>Baby Shoe</h5>
                <p>52 Items</p>
        ...
        <div class="col-lg-2 col-md-3 col-sm-4 col-6">
          <div class="baby_category_card">
            <a href="shop.html">
              <div class="baby_cat_img">
                <img src="assets/img/baby-shop/product/cat-5.png" alt="img">
              </div>
              <div class="baby_cat_content">
                <h5>Baby toy,s</h5>
                <p>90 Items</p>
        ...
        <div class="col-lg-2 col-md-3 col-sm-4 col-6">
          <div class="baby_category_card">
            <a href="shop.html">
              <div class="baby_cat_img">
                <img src="assets/img/baby-shop/product/cat-6.png" alt="img">
              </div>
              <div class="baby_cat_content">
                <h5>Baby shirts</h5>
                <p>20 Items</p>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
          <div class="baby_offer_one_img hover_area_translateY">
            <a href="shop.html"><img src="assets/img/baby-shop/banner/offer-1.png" alt="img"></a>
          </div>
        </div>
        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
          <div class="baby_offer_one_img hover_area_translateY">
            <a href="shop.html"><img src="assets/img/baby-shop/banner/offer-2.png" alt="img"></a>
          </div>
        </div>
        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
          <div class="baby_offer_one_img hover_area_translateY">
            <a href="shop.html"><img src="assets/img/baby-shop/banner/offer-3.png" alt="img"></a>
          </div>
        </div>
      </div>
    </div>
  ...
  <!-- Trending Product -->
  <section id="baby_trending_product" class="ptb-100">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <div class="jewellary_heading">
        ...
        <div class="col-lg-12">
          <div class="tabs_center_button">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
              <li role="presentation"><a data-bs-toggle="tab" data-bs-target="#top_seller" role="tab" href="#!">TOP
                  SELLER</a></li>
              <li role="presentation"><a data-bs-toggle="tab" data-bs-target="#new_arrival" href="#!">NEW ARRIVAL</a>
              </li>
              <li role="presentation"><a data-bs-toggle="tab" data-bs-target="#top_rated" href="#!">TOP RATED</a></li>
            </ul>
          </div>
        </div>
        <div class="col-lg-12">
          <div class="tabs_el_wrapper">
            <div class="tab-content" id="myTabContent">
              <div id="top_seller" class="tab-pane fade show in active" role="tabpanel">
                <div class="row">
                  <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                    <div class="jewellary_product_card">
                      <div class="jewellary_product_img">
                        <a href="product-single.html">
                          <img src="assets/img/baby-shop/product/pro-1.png" alt="img">
                        </a>
                        <div class="jewellary_product_icon">
                          <ul>
                            <li><a href="#!" data-link-action="quickview" title="Quick view" data-bs-toggle="modal"
                                data-bs-target="#exampleModalCenter"><i class="fas fa-eye"></i></a></li>
                            <li><a href="#!" data-bs-toggle="modal" data-bs-target="#shoppingCartModal"><i
                                  class="fas fa-shopping-cart"></i></a></li>
                            <li><a href="#!" data-bs-toggle="modal" data-bs-target="#shoppingWishlistModal"><i
                                  class="fas fa-heart"></i></a></li>
                            <li><a href="compare.html"><i class="fas fa-sync-alt"></i></a></li>
                          </ul>
                        </div>
                      </div>
                      <div class="jewellary_product_text">
                        <h3><a href="shop-2.html">Teddy Bear</a></h3>
                        <p>Explore new and hottest products from our web site</p>
                        <h4>$100.00 <span><del>$120.00</del></span></h4>
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                    <div class="jewellary_product_card">
                      <div class="jewellary_product_img">
                        <a href="product-single.html">
                          <img src="assets/img/baby-shop/product/pro-2.png" alt="img">
                        </a>
                        <div class="jewellary_product_icon">
                          <ul>
                            <li><a href="#!" data-link-action="quickview" title="Quick view" data-bs-toggle="modal"
                  ...
                  <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                    <div class="jewellary_product_card">
                      <div class="jewellary_product_img">
                        <a href="product-single.html">
                          <img src="assets/img/baby-shop/product/pro-3.png" alt="img">
                        </a>
                        <div class="jewellary_product_icon">
                          <ul>
                            <li><a href="#!" data-link-action="quickview" title="Quick view" data-bs-toggle="modal"
                  ...
                  <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                    <div class="jewellary_product_card">
                      <div class="jewellary_product_img">
                        <a href="product-single.html">
                          <img src="assets/img/baby-shop/product/pro-4.png" alt="img">
                        </a>
                        <div class="jewellary_product_icon">
                          <ul>
                            <li><a href="#!" data-link-action="quickview" title="Quick view" data-bs-toggle="modal"
                  ...
                  <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                    <div class="jewellary_product_card">
                      <div class="jewellary_product_img">
                        <a href="product-single.html">
                          <img src="assets/img/baby-shop/product/pro-5.png" alt="img">
                        </a>
                        <div class="jewellary_product_icon">
                          <ul>
                            <li><a href="#!" data-link-action="quickview" title="Quick view" data-bs-toggle="modal"
                  ...
                  <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                    <div class="jewellary_product_card">
                      <div class="jewellary_product_img">
                        <a href="product-single.html">
                          <img src="assets/img/baby-shop/product/pro-6.png" alt="img">
                        </a>
                        <div class="jewellary_product_icon">
                          <ul>
                            <li><a href="#!" data-link-action="quickview" title="Quick view" data-bs-toggle="modal"
                  ...
                  <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                    <div class="jewellary_product_card">
                      <div class="jewellary_product_img">
                        <a href="product-single.html">
                          <img src="assets/img/baby-shop/product/pro-7.png" alt="img">
                        </a>
                        <div class="jewellary_product_icon">
                          <ul>
                            <li><a href="#!" data-link-action="quickview" title="Quick view" data-bs-toggle="modal"
                  ...
                  <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                    <div class="jewellary_product_card">
                      <div class="jewellary_product_img">
                        <a href="product-single.html">
                          <img src="assets/img/baby-shop/product/pro-8.png" alt="img">
                        </a>
                        <div class="jewellary_product_icon">
                          <ul>
                            <li><a href="#!" data-link-action="quickview" title="Quick view" data-bs-toggle="modal"
              ...
              <div id="new_arrival" class="tab-pane fade" role="tabpanel">
                <div class="row">
                  <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                    <div class="jewellary_product_card">
                      <div class="jewellary_product_img">
              ...
              <div id="top_rated" class="tab-pane fade" role="tabpanel">
                <div class="row">
                  <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                    <div class="jewellary_product_card">
                      <div class="jewellary_product_img">
  ...
  <div id="baby_offer_banner">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <div class="baby_offer_banner_text">
            <h2>Off For Kids Collection</h2>
            <a href="shop.html" class="theme-btn-one bg-black btn_md">View collection</a>
            <div class="baby_todays_count">
  ...
  <!-- Top Product -->
  <section id="baby_top_product" class="ptb-100 dots_style">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <div class="jewellary_heading">
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="baby_top_slider  owl-carousel owl-theme">
            <div class="jewellary_product_card">
              <div class="jewellary_product_img">
                <a href="product-single.html">
                  <img src="assets/img/baby-shop/product/pro-1.png" alt="img">
  ...
  <!-- Banner Bottom -->
  <div id="baby_banner_bottom" class="pb-100">
    <div class="container">
      <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
          <div class="baby_banner_bottom_img hover_area_translateY">
            <a href="shop-2.html"><img src="assets/img/baby-shop/banner/bt-offer-1.png" alt="img"></a>
          </div>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
          <div class="baby_banner_bottom_img hover_area_translateY">
            <a href="shop-2.html"><img src="assets/img/baby-shop/banner/bt-offer-2.png" alt="img"></a>
          </div>
        </div>
      </div>
    </div>
  ...
  <!-- Blog Area -->
  <section id="baby_blog_arae" class="pb-100">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <div class="jewellary_heading">
      ...
      <div class="row">
        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
          <div class="baby_blog_card">
            <div class="baby_blog_thumb">
              <a href="blog-single.html">
                <img src="assets/img/baby-shop/blog/blog-3.jpg" alt="img">
              </a>
            </div>
            <div class="baby_blog_content">
              <span>January 08, 09:14 am</span>
              <h3><a href="blog-single.html">We know that buying shop</a></h3>
              <p>Class integer tellus praesent at torquent cras, potenti erat fames
                volutpat etiam.</p>
        ...
        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
          <div class="baby_blog_card">
            <div class="baby_blog_thumb">
              <a href="blog-single.html">
                <img src="assets/img/baby-shop/blog/blog-2.jpg" alt="img">
              </a>
            </div>
            <div class="baby_blog_content">
              <span>January 08, 09:14 am</span>
              <h3><a href="blog-single.html">We bring you the best </a></h3>
              <p>Class integer tellus praesent at torquent cras, potenti erat fames
                volutpat etiam.</p>
              <a href="blog-single.html" class="read_more">Read more</a>
            </div>
        ...
        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
          <div class="baby_blog_card">
            <div class="baby_blog_thumb">
              <a href="blog-single.html">
                <img src="assets/img/baby-shop/blog/blog-1.jpg" alt="img">
              </a>
            </div>
            <div class="baby_blog_content">
              <span>January 08, 09:14 am</span>
          ...
          <div class="instagram_post_slider owl-carousel owl-theme">
            <div class="instgram_post">
              <a href="#!">
                ...
                <img src="assets/img/baby-shop/instagram/ig_01.png" alt="img" />
              </a>
            </div>
            <div class="instgram_post">
              <a href="#!">
                <i class="fab fa-instagram"></i>
                <img src="assets/img/baby-shop/instagram/ig_02.png" alt="img" />
              </a>
            </div>
            <div class="instgram_post">
              <a href="#!">
                <i class="fab fa-instagram"></i>
                <img src="assets/img/baby-shop/instagram/ig_03.png" alt="img" />
              </a>
            </div>
            <div class="instgram_post">
              <a href="#!">
                <i class="fab fa-instagram"></i>
                <img src="assets/img/baby-shop/instagram/ig_04.png" alt="img" />
              </a>
            </div>
            <div class="instgram_post">
              <a href="#!">
                <i class="fab fa-instagram"></i>
                <img src="assets/img/baby-shop/instagram/ig_05.png" alt="img" />
              </a>
            </div>
            <div class="instgram_post">
              <a href="#!">
                <i class="fab fa-instagram"></i>
                <img src="assets/img/baby-shop/instagram/ig_06.png" alt="img" />
              </a>
            </div>
            <div class="instgram_post">
              <a href="#!">
                <i class="fab fa-instagram"></i>
                <img src="assets/img/baby-shop/instagram/ig_07.png" alt="img" />
              </a>
            </div>
            <div class="instgram_post">
              <a href="#!">
                <i class="fab fa-instagram"></i>
                <img src="assets/img/baby-shop/instagram/ig_08.png" alt="img" />
              </a>
            </div>
            <div class="instgram_post">
              <a href="#!">
                <i class="fab fa-instagram"></i>
                <img src="assets/img/baby-shop/instagram/ig_09.png" alt="img" />
              </a>
            </div>
            <div class="instgram_post">
              <a href="#!">
                <i class="fab fa-instagram"></i>
                <img src="assets/img/baby-shop/instagram/ig_10.png" alt="img" />
              </a>
            </div>
            <div class="instgram_post">
              <a href="#!">
              ...
              <div class="row">
                    ...
                    <form action="#!">
                      <div class="input-group mb-3">
                        ...
                        <div class="input-group-append">
                          <button class="theme-btn-one btn-black-overlay btn_sm">Subscribe</button>
                        </div>
                      </div>
                ...
                <div class="col-lg-5 col-md-12">
                  <div class="offer_modal_img d-none d-lg-block">
                    <img src="assets/img/common/modal.png" alt="img">
                  </div>
                </div>
              </div>
          ...
          <div class="row">
            <div class="col-lg-5 col-md-6 col-sm-12 col-12">
              <div class="products_modal_sliders owl-carousel owl-theme">
                <img src="assets/img/pharmacy/product/pro-1.png" alt="img" />
                <img src="assets/img/pharmacy/product/pro-2.png" alt="img" />
                <img src="assets/img/pharmacy/product/pro-3.png" alt="img" />
                <img src="assets/img/pharmacy/product/pro-4.png" alt="img" />
                <img src="assets/img/pharmacy/product/pro-5.png" alt="img" />
                <img src="assets/img/pharmacy/product/pro-1.png" alt="img" />
                <img src="assets/img/pharmacy/product/pro-2.png" alt="img" />
              </div>
            </div>
                ...
                <div class="variable-single-item">
                  ...
                  <div class="product-variable-color">
                    <label for="modal-product-color-red1">
                      <input name="modal-product-color" id="modal-product-color-red1" class="color-select" type="radio"
                        checked="">
                      <span class="product-color-red"></span>
                    </label>
                    <label for="modal-product-color-green3">
                      <input name="modal-product-color" id="modal-product-color-green3" class="color-select"
                        type="radio">
                      <span class="product-color-green"></span>
                    </label>

                    <label for="modal-product-color-blue5">
                      <input name="modal-product-color" id="modal-product-color-blue5" class="color-select"
                        type="radio">
                ...
                <form action="#!" id="product_count_form_one">
                  <div class="product_count_one">
                    <div class="plus-minus-input">
                      ...
                      <div class="input-group-button">
                        <button type="button" class="button" data-quantity="plus" data-field="quantity">
...
<!-- Mirrored from andit.co/projects/html/andshop/andshop_frontend/baby-shop.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Apr 2023 19:35:44 GMT -->
</html>