...
<!-- Mirrored from andit.co/projects/html/andshop/andshop_frontend/blog-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Apr 2023 19:38:38 GMT -->
<head>
    <meta charset="UTF-8">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-md-12 col-sm-12 col-12">
                                <div class="blog_text">
                                    ...
                                    <h4 class="heading"><a href="blog-single.html">If You Struggle To Hit Your Goals,
                                            Try This Instead</a></h4>
                                    <p class="para">This year, instead of setting grand, lofty goals and New Years
                                        Resolutions, I realized that I respond better to smaller targets that I can
                                        cross</p>
                    ...
                    <div class="blog_list_item img-zoom-hover">
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-md-12 col-sm-12 col-12">
                                <div class="blog_text">
                                    <h5 class="date_area"><a href="blog-single.html">24 February 2021</a></h5>
                                    <h4 class="heading"><a href="blog-single.html">Hawaii Couples Trip Guide and Spring
                                            Break Faves</a></h4>
                                    <p class="para">After every trip to Hawaii, I always have a few DMs asking where we
                                        stayed, our favorite beaches, etc. Especially with spring break around the
                                        corner.</p>
                                    <a href="blog-single.html" class="button">Read More<i
                                            class="fas fa-arrow-right"></i></a>
                                </div>
                            ...
                            <div class="col-lg-8 col-md-12 col-sm-12 col-12">
                                <div class="blog_text">
                                    ...
                                    <h4 class="heading"><a href="blog-single.html">4 Tips for A Colorful Easter
                                            Tablescape</a></h4>
                                    <p class="para">Spring is all about the colors! Especially after what feels like an
                                        endless winter, I catch myself craving more color than usual.</p>
                                    <a href="blog-single.html" class="button">Read More<i
                                            class="fas fa-arrow-right"></i></a>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-8 col-md-12 col-sm-12 col-12">
                                <div class="blog_text">
                                    ...
                                    <h4 class="heading"><a href="blog-single.html">This Designer Bronzer Has Even Buyers
                                            Splurging!</a></h4>
                                    <p class="para">Today kicks off early access to the Sephora Spring Sales Event so I
                                        wanted to share some of my top recent beauty buys</p>
                                    <a href="blog-single.html" class="button">Read More<i
                                            class="fas fa-arrow-right"></i></a>
                                </div>
                            </div>
