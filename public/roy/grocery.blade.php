...
<!-- Mirrored from andit.co/projects/html/andshop/andshop_frontend/grocery.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Apr 2023 19:33:55 GMT -->
<head>
    <meta charset="UTF-8" />
...
<body>
                        ...
                        <ul class="navbar-nav">
                            <li class="nav-item"><a href="#" class="nav-link active">Home <i
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item"><a href="grocery.html" class="nav-link active">Grocery</a></li>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                    <div class="grocery_banner_img">
                        <a href="shop-3.html">
                            <img src="assets/img/grocery/banner/banner1.png" alt="img">
                        </a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                    <div class="grocery_banner_img">
                        <a href="shop-3.html">
                            <img src="assets/img/grocery/banner/banner2.png" alt="img">
                        </a>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-6 col-12">
                            <div class="grocery_banner_img  banner_last_img">
                                <a href="shop-3.html">
                                    <img src="assets/img/grocery/banner/banner3.png" alt="img">
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-6 col-12">
                            <div class="grocery_banner_img">
                                <a href="shop-3.html">
                                    <img src="assets/img/grocery/banner/banner4.png" alt="img">
                                </a>
                            </div>
                        </div>
                    </div>
    ...
    <section id="grocery_category_top" class="ptb-100 slider_button_style">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="grocery_categories_slider owl-carousel owl-theme">
                        <div class="grocery_small_item">
                            <a href="shop-3.html">
                                <img src="assets/img/grocery/product/cat_item1.png" alt="item">
                                <h4>Fresh fruit</h4>
                                <p>51 items</p>
                            </a>
                        </div>
                        <div class="grocery_small_item">
                            <a href="shop-3.html">
                                <img src="assets/img/grocery/product/cat_item2.png" alt="item">
                                <h4>Fresh fruit</h4>
                                <p>51 items</p>
                            </a>
                        </div>
                        <div class="grocery_small_item">
                            <a href="shop-3.html">
                                <img src="assets/img/grocery/product/cat_item3.png" alt="item">
                                <h4>Fresh fruit</h4>
                                <p>51 items</p>
                            </a>
                        </div>
                        <div class="grocery_small_item">
                            <a href="shop-3.html">
                                <img src="assets/img/grocery/product/cat_item4.png" alt="item">
                                <h4>Fresh fruit</h4>
                                <p>51 items</p>
                            </a>
                        </div>
                        <div class="grocery_small_item">
                            <a href="shop-3.html">
                                <img src="assets/img/grocery/product/cat_item5.png" alt="item">
                                <h4>Fresh fruit</h4>
                                <p>51 items</p>
                            </a>
                        </div>
                        <div class="grocery_small_item">
                            <a href="shop-3.html">
                                <img src="assets/img/grocery/product/cat_item6.png" alt="item">
                                <h4>Fresh fruit</h4>
                                <p>51 items</p>
                            </a>
                        </div>
                        <div class="grocery_small_item">
                            <a href="shop-3.html">
                                <img src="assets/img/grocery/product/cat_item7.png" alt="item">
                                <h4>Fresh fruit</h4>
                                <p>51 items</p>
                            </a>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="discount_item">
                        <a href="shop.html"><img src="assets/img/grocery/offer/top-offer-1.png" alt="img"></a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="discount_item">
                        <a href="shop.html"><img src="assets/img/grocery/offer/top-offer-2.png" alt="img"></a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="discount_item">
                        <a href="shop.html"><img src="assets/img/grocery/offer/top-offer-3.png" alt="img"></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="grocery_featured_area" class="ptb-100 slider_button_style">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="featured_grocery_slider owl-carousel owl-theme">
                        <div class="sp_product_item">
                            <div class="sp_product_thumb">
                                <span class="batch">New</span>
                                <a href="product-single.html">
                                    <img src="assets/img/grocery/product/cat_item1.png" alt="img">
                                </a>
                            </div>
                            <div class="sp_product_content">
                                ...
                                <h6><a href="#!" data-bs-toggle="modal" data-bs-target="#shoppingCartModal">Uncle Orange
                                        Vanla Ready Pice</a></h6>
                                <span class="product_status">IN Stock</span>
                        ...
                        <div class="sp_product_item">
                            <div class="sp_product_thumb">
                                <span class="batch">New</span>
                                <a href="product-single.html">
                                    <img src="assets/img/grocery/product/cat_item2.png" alt="img">
                                </a>
                            </div>
                            <div class="sp_product_content">
                                <div class="rating_sp">
                        ...
                        <div class="sp_product_item">
                            <div class="sp_product_thumb">
                                <span class="batch">New</span>
                                <a href="product-single.html">
                                    <img src="assets/img/grocery/product/cat_item3.png" alt="img">
                                </a>
                            </div>
                            <div class="sp_product_content">
                                <div class="rating_sp">
                        ...
                        <div class="sp_product_item">
                            <div class="sp_product_thumb">
                                <span class="batch">New</span>
                                <a href="product-single.html">
                                    <img src="assets/img/grocery/product/cat_item7.png" alt="img">
                                </a>
                            </div>
                            <div class="sp_product_content">
                                <div class="rating_sp">
                        ...
                        <div class="sp_product_item">
                            <div class="sp_product_thumb">
                                <span class="batch">New</span>
                                <a href="product-single.html">
                                    <img src="assets/img/grocery/product/cat_item8.png" alt="img">
                                </a>
                            </div>
                            <div class="sp_product_content">
                                <div class="rating_sp">
                        ...
                        <div class="sp_product_item">
                            <div class="sp_product_thumb">
                                <span class="batch">New</span>
                                <a href="product-single.html">
                                    <img src="assets/img/grocery/product/cat_item9.png" alt="img">
                                </a>
                            </div>
                            <div class="sp_product_content">
                                <div class="rating_sp">
                        ...
                        <div class="sp_product_item">
                            <div class="sp_product_thumb">
                                <span class="batch">New</span>
                                <a href="product-single.html">
                                    <img src="assets/img/grocery/product/cat_item5.png" alt="img">
                                </a>
                            </div>
                            <div class="sp_product_content">
                                <div class="rating_sp">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="grocery_todays_area_left">
                        ...
                        <div class="grocery_todays_img">
                            <img src="assets/img/grocery/product/cat_item10.png" alt="img">
                        </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                            <div class="sp_product_item">
                                ...
                                <div class="sp_product_content">
                                    ...
                                    <h6><a href="#!" data-bs-toggle="modal" data-bs-target="#shoppingCartModal">Uncle
                                            Orange Vanla Ready Pice</a></h6>
                                    <span class="product_status">IN Stock</span>
                                    <div class="sp_cart_wrap">
                                        <form action="#!">
                                            <div class="cart_plus_minus">
                ...
                <div class="row align-items-center">
                        ...
                        <div class="grocery_cta_content">
                            ...
                            <form action="#">
                                <div class="input-group mb-3">
                                    ...
                                    <button class="btn_cta" type="submit"><i class="fas fa-paper-plane"></i></button>
                                </div>
                            </form>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="grocery_cta">
                            <img src="assets/img/grocery/offer/cta.png" alt="img">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section id="grocery_trending_product" class="pb-100 slider_button_style">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="grocery_trending_product owl-carousel owl-theme">
                        <div class="grocery_small_item">
                            <a href="product-single.html">
                                <img src="assets/img/grocery/product/cat_item1.png" alt="item">
                                <h4>Fresh fruit</h4>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="grcery_support_boxed">
                        <img src="assets/img/grocery/icon/free.svg" alt="icon">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="grcery_support_boxed">
                        <img src="assets/img/grocery/icon/refund.svg" alt="icon">
                        <div class="support_boxed_grocery_content">
                            <h5>Refundable</h5>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="grcery_support_boxed">
                        <img src="assets/img/grocery/icon/secure.svg" alt="icon">
                        <div class="support_boxed_grocery_content">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="grcery_support_boxed">
                        <img src="assets/img/grocery/icon/support.svg" alt="icon">
                        <div class="support_boxed_grocery_content">
...
<!-- Mirrored from andit.co/projects/html/andshop/andshop_frontend/grocery.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Apr 2023 19:34:19 GMT -->
</html>