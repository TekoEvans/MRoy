...
<!-- Mirrored from andit.co/projects/html/andshop/andshop_frontend/email-template-two.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Apr 2023 19:37:44 GMT -->
<head>
    <meta charset="UTF-8" />
...
<body style="margin: 20px auto;">
            ...
            <tr>
                <td>
                    ...
                    <table class="slider" align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <th align="center" width="40%"><a href="#!"><img src="assets/img/email/e-2-slider.jpg"
                                        alt="" style="margin-bottom: -5px;"></a>
                </td>
            </tr>
    </table>
    <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-top:30px;">
        ...
        <tr>
            <td>
                <div class="product-box hover">
                    <div class="product border-theme br-0">
                        <img src="assets/img/email/p1.jpg" alt="product" style="width: 100%;">
                    </div>
            ...
            <td>
                <div class="product-box hover">
                    <div class="product border-theme br-0">
                        <img src="assets/img/email/p2.jpg" alt="product" style="width: 100%;">
                    </div>
                    <div class="product-info">
                        <div class="rating">
    ...
    <table border="0" cellpadding="0" cellspacing="0" align="center" style="margin-top:30px;">
        <tbody>
            <tr align="center" class="add-with-banner">
                <td>
                    <a href="#"><img src="assets/img/email/banner.jpg" alt="product" style="width: 100%;"></a>
                </td>
    ...
    <table border="0" cellpadding="0" cellspacing="0" align="center" style="margin-top:30px;">
        <tr>
            <td>
                <img src="assets/img/email/banner-2.jpg" alt="" style="width: 100%;">
            </td>
        </tr>
    </table>
    <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-top: 30px;">
            ...
            <td align="center">
                <table align="center" border="0" class="display-width-inner" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td align="center" style="width: 40%;">
                            <img src="assets/img/email/ps1.jpg" alt="" style="width: 225px;margin-bottom: -4px;">
                        </td>
                ...
                <table align="center" border="0" class="display-width-inner" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        ...
                        <td align="center" style="width: 40%;">
                            <img src="assets/img/email/ps2.jpg" alt="" style="width: 225px;margin-bottom: -4px;">
                        </td>
                    </tr>
                </table>
                ...
                <table align="center" border="0" class="display-width-inner" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td align="center" style="width: 40%;">
                            <img src="assets/img/email/ps3.jpg" alt="" style="width: 225px;margin-bottom: -4px;">
                        </td>
                        <td align="center" style="background-color: #fafafa;width: 60%;">
                            <h3 style="margin: 0;">Product One</h3>
                            <div
        ...
        <tr>
            <td style="padding: 30px;">
                ...
                <table border="0" cellpadding="0" cellspacing="0" class="footer-social-icon" align="center"
                    ...
                    <tr>
                        <td>
                            <a href="#"><img src="assets/img/email/facebook.png" alt=""></a>
                        </td>
                        <td>
                            <a href="#"><img src="assets/img/email/youtube.png" alt=""></a>
                        </td>
                        <td>
                            <a href="#"><img src="assets/img/email/twitter.png" alt=""></a>
                        </td>
                        <td>
                            <a href="#"><img src="assets/img/email/gplus.png" alt=""></a>
                        </td>
                        <td>
                            <a href="#"><img src="assets/img/email/linkedin.png" alt=""></a>
                        </td>
                        <td>
                            <a href="#"><img src="assets/img/email/pinterest.png" alt=""></a>
                        </td>
                    </tr>
                </table>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin: 20px auto 0;">
                    ...
                    <tr>
                        <td>
                            <p style="font-size:13px; margin:0;">2021 Copy Right by Themeforest powerd by andit_themes
                            </p>
                        </td>
                    </tr>
                    <tr>
...
<!-- Mirrored from andit.co/projects/html/andshop/andshop_frontend/email-template-two.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Apr 2023 19:37:52 GMT -->
</html>