...
<!-- Mirrored from andit.co/projects/html/andshop/andshop_frontend/add-product.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Apr 2023 19:38:53 GMT -->
<head>
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <!-- Title -->
    <title>Add Product - AndShop</title>
    <!-- Bootstrap css -->
                ...
                <div class="col-lg-8 offset-lg-2">
                    <div class="add_product_wrapper">
                        <div class="back_to_area">
                            <a href="vendor.html"><i class="fas fa-long-arrow-alt-left"></i> Back To Dashboard</a>
                        </div>
                        <h3>Add Product</h3>
