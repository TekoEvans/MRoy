...
<!-- Mirrored from andit.co/projects/html/andshop/andshop_frontend/pharmacy.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Apr 2023 19:34:19 GMT -->
<head>
    <meta charset="UTF-8" />
...
<body>
                        ...
                        <ul class="navbar-nav">
                            <li class="nav-item"><a href="#" class="nav-link active">Home <i
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item"><a href="pharmacy.html" class="nav-link active">Pharmacy</a>
                                    </li>
                ...
                <div class="col-lg-8">
                    <div class="pharmacy_banner_img">
                        <a href="shop-right-sidebar.html">
                            <img src="assets/img/pharmacy/banner/banner1.png" alt="img">
                        </a>
                    </div>
                </div>
                <div class="col-lg-4">
                        ...
                        <div class="col-lg-12 col-md-6 col-sm-6 col-12">
                            <div class="pharmacy_banner_img banner_last_img">
                                <a href="shop-left-sidebar.html">
                                    <img src="assets/img/pharmacy/banner/banner2.png" alt="img">
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-6 col-sm-6 col-12">
                            <div class="pharmacy_banner_img banner_last_img">
                                <a href="shop-left-sidebar.html">
                                    <img src="assets/img/pharmacy/banner/banner3.png" alt="img">
                                </a>
                            </div>
                        </div>
                    </div>
    ...
    <section id="pharmacy_categorie" class="ptb-100 slider_button_left_right">
        <div class="container">
            ...
            <div class="row position-relative">
                <div class="col-lg-12">
                    <div class="pharmacy_top_cate owl-carousel owl-theme">
                        <div class="pharmacy_top_card">
                            <a href="shop-3.html">
                                <img src="assets/img/pharmacy/product/prod1.png" alt="img">
                                <h4>Health care</h4>
                            </a>
                        </div>
                        <div class="pharmacy_top_card">
                            <a href="shop-3.html">
                                <img src="assets/img/pharmacy/product/prod2.png" alt="img">
                                <h4>Antiseptic</h4>
                            </a>
                        </div>
                        <div class="pharmacy_top_card">
                            <a href="shop-3.html">
                                <img src="assets/img/pharmacy/product/prod3.png" alt="img">
                                <h4>Medicine</h4>
                            </a>
                        </div>
                        <div class="pharmacy_top_card">
                            <a href="shop-3.html">
                                <img src="assets/img/pharmacy/product/prod4.png" alt="img">
                                <h4>Medical kit</h4>
                            </a>
                        </div>
                        <div class="pharmacy_top_card">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="pharmacy_promo_img">
                        <a href="shop-2.html"><img src="assets/img/pharmacy/banner/sm-banner1.png" alt="img"></a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="pharmacy_promo_img">
                        <a href="shop-2.html"><img src="assets/img/pharmacy/banner/sm-banner2.png" alt="img"></a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="pharmacy_promo_img">
                        <a href="shop-2.html"><img src="assets/img/pharmacy/banner/sm-banner3.png" alt="img"></a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-12">
                    <div class="tabs_left_button">
                        <ul class="nav nav-tabs">
                            <li><a data-bs-toggle="tab" data-bs-target="#rated" href="#!" class="active">Top rated</a>
                            </li>
                            <li><a data-bs-toggle="tab" data-bs-target="#popular" href="#!">Popular</a></li>
                                ...
                                <div class="row">
                                        ...
                                        <div class="pharmacy_product_card">
                                            <div class="pharmacy_product_img">
                                                <a href="product-single.html"><img
                                                        src="assets/img/pharmacy/product/pro-1.png" alt="img"></a>
                                                <span class="batch">Hot</span>
                                                <div class="pharmacy_product_icon">
                                                    <ul>
                                                        <li><a href="#!" data-link-action="quickview" title="Quick view"
                                                        ...
                                                        <li><a href="compare.html"><i class="fas fa-sync-alt"></i></a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                        <div class="pharmacy_product_card">
                                            <div class="pharmacy_product_img">
                                                <a href="product-single.html"><img
                                                        src="assets/img/pharmacy/product/pro-2.png" alt="img"></a>
                                                <span class="batch">Hot</span>
                                                <div class="pharmacy_product_icon">
                                                    <ul>
                                                        <li><a href="#!" data-link-action="quickview" title="Quick view"
                                    ...
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                        <div class="pharmacy_product_card">
                                            <div class="pharmacy_product_img">
                                                <a href="product-single.html"><img
                                                        src="assets/img/pharmacy/product/pro-3.png" alt="img"></a>
                                                <span class="batch">Hot</span>
                                                <div class="pharmacy_product_icon">
                                                    <ul>
                                                        <li><a href="#!" data-link-action="quickview" title="Quick view"
                                    ...
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                        <div class="pharmacy_product_card">
                                            <div class="pharmacy_product_img">
                                                <a href="product-single.html"><img
                                                        src="assets/img/pharmacy/product/pro-4.png" alt="img"></a>
                                                <span class="batch">Hot</span>
                                                <div class="pharmacy_product_icon">
                                                    <ul>
                                                        <li><a href="#!" data-link-action="quickview" title="Quick view"
                                    ...
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                        <div class="pharmacy_product_card">
                                            <div class="pharmacy_product_img">
                                                <a href="product-single.html"><img
                                                        src="assets/img/pharmacy/product/pro-5.png" alt="img"></a>
                                                <span class="batch">Hot</span>
                                                <div class="pharmacy_product_icon">
                                                    <ul>
                                                        <li><a href="#!" data-link-action="quickview" title="Quick view"
                    ...
                    <div class="pharmacy_time_area">
                        ...
                        <div class="pharmacy_todays_count">
                            <div id="pharmacy_grocery">
                                <ul>
                                    <li><span id="days">262</span>days</li>
                                    <li><span id="hours">5</span>Hours</li>
                                    <li><span id="minutes">21</span>Minutes</li>
                                    <li><span id="seconds">21</span>Seconds</li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="pharmacy_date_img">
                                <a href="shop-right-sidebar.html"><img src="assets/img/pharmacy/banner/mid-1.png"
                                        alt="img"></a>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="pharmacy_date_img">
                                <a href="shop-right-sidebar.html"><img src="assets/img/pharmacy/banner/mid-2.png"
                                        alt="img"></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="pharmacy_date_img">
                                <a href="shop-right-sidebar.html"><img src="assets/img/pharmacy/banner/mid-3.png"
                                        alt="img"></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-12">
                    <div class="row">
                        <div class="col-lg-12 col-md-6">
                            <div class="pharmacy_date_img">
                                <a href="shop-right-sidebar.html"><img src="assets/img/pharmacy/banner/mid-4.png"
                                        alt="img"></a>
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-6">
                            <div class="pharmacy_date_img">
                                <a href="shop-right-sidebar.html"><img src="assets/img/pharmacy/banner/mid-5.png"
                                        alt="img"></a>
                            </div>
                        </div>
                    </div>
    ...
    <section id="pharmacy_hot_item" class="pt-100 slider_button_left_right">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="pharmacy_hot_item_slider owl-carousel owl-theme">
                        <!-- Hot Item -->
                        <div class="pharmacy_product_card">
                            <div class="pharmacy_product_img">
                                <a href="product-single.html"><img src="assets/img/pharmacy/product/pro-1.png"
                                        alt="img"></a>
                                <span class="batch">Hot</span>
                                <div class="pharmacy_product_icon">
                                    <ul>
                                        ...
                                        <li><a href="#!" data-bs-toggle="modal" data-bs-target="#shoppingCartModal"><i
                                                    class="fas fa-shopping-cart"></i></a></li>
                                        <li><a href="#!" data-bs-toggle="modal"
                                                data-bs-target="#shoppingWishlistModal"><i class="fas fa-heart"></i></a>
                                        </li>
    ...
    <section id="pharmacy_top_brand" class="ptb-100 slider_button_left_right">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="pharmacy_top_brand_slider owl-carousel owl-theme">
                        <div class="partner_logo_pharmacy">
                            <a href="#!"><img src="assets/img/pharmacy/partner/partner_1.png" alt="img"></a>
                        </div>
                        <div class="partner_logo_pharmacy">
                            <a href="#!"><img src="assets/img/pharmacy/partner/partner_2.png" alt="img"></a>
                        </div>
                        <div class="partner_logo_pharmacy">
                            <a href="#!"><img src="assets/img/pharmacy/partner/partner_3.png" alt="img"></a>
                        </div>
                        <div class="partner_logo_pharmacy">
                            <a href="#!"> <img src="assets/img/pharmacy/partner/partner_4.png" alt="img"></a>
                        </div>
                        <div class="partner_logo_pharmacy">
                            <a href="#!"><img src="assets/img/pharmacy/partner/partner_5.png" alt="img"></a>
                        </div>
                        <div class="partner_logo_pharmacy">
                            <a href="#!"> <img src="assets/img/pharmacy/partner/partner_1.png" alt="img"></a>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-8 col-md-8 col-sm-12 col-12">
                    <div class="pharmacy_banner_bottom_img">
                        <a href="shop-right-sidebar.html"><img src="assets/img/pharmacy/banner/add-1.png" alt="img"></a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                    <div class="pharmacy_banner_bottom_img">
                        <a href="shop-right-sidebar.html"><img src="assets/img/pharmacy/banner/add-2.png" alt="img"></a>
                    </div>
                </div>
            </div>
        </div>
...
<!-- Mirrored from andit.co/projects/html/andshop/andshop_frontend/pharmacy.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Apr 2023 19:34:49 GMT -->
</html>