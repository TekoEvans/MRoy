...
<!-- Mirrored from andit.co/projects/html/andshop/andshop_frontend/checkout-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Apr 2023 19:37:26 GMT -->
<head>
    <meta charset="UTF-8">
                        ...
                        <div id="checkout_coupon" class="collapse checkout_coupon" data-parent="#checkout_coupon">
                            <div class="checkout_info">
                                <form action="#">
                                    ...
                                    <button class="theme-btn-one btn btn-black-overlay btn-md" type="submit">Apply
                                        coupon</button>
                                </form>
                            </div>
                        </div>
                                ...
                                <form action="#">
                                    ...
                                    <div class="payment_method">
                                        <div class="panel-default">
                                            <label class="checkbox-default" for="currencyCod" data-toggle="collapse"
                                        ...
                                        <div class="panel-default">
                                            <label class="checkbox-default" for="currencyPaypal" data-toggle="collapse"
                                        ...
                                        <div class="order_button pt-3">
                                            <button class="theme-btn-one btn-black-overlay btn_sm" type="submit">Proceed
                                                to
                                                PayPal</button>
                                        </div>
                                    </div>
