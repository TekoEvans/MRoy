...
<!-- Mirrored from andit.co/projects/html/andshop/andshop_frontend/car.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Apr 2023 19:36:26 GMT -->
<head>
  <meta charset="UTF-8" />
...
<body>
  ...
  <!-- Banner Area -->
  <section id="banner_sport">
    <div class="sport_banner_img">
      <img src="assets/img/car/common/banner.png" alt="img">
    </div>
  </section>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-2 col-md-3 col-sm-6 col-12">
          <div class="car_sports_category">
            <img src="assets/img/car/icon/icon-1.png" alt="img">
            <h4>Radiator</h4>
          </div>
        </div>
        <div class="col-lg-2 col-md-3 col-sm-6 col-12">
          <div class="car_sports_category">
            <img src="assets/img/car/icon/icon-2.png" alt="img">
            <h4>Muffler</h4>
          </div>
        </div>
        <div class="col-lg-2 col-md-3 col-sm-6 col-12">
          <div class="car_sports_category">
            <img src="assets/img/car/icon/icon-3.png" alt="img">
            <h4>Car clutch</h4>
          </div>
        </div>
        <div class="col-lg-2 col-md-3 col-sm-6 col-12">
          <div class="car_sports_category">
            <img src="assets/img/car/icon/icon-4.png" alt="img">
            <h4>Alternator</h4>
          </div>
        </div>
        <div class="col-lg-2 col-md-3 col-sm-6 col-12">
          <div class="car_sports_category">
            <img src="assets/img/car/icon/icon-5.png" alt="img">
            <h4>Car battery</h4>
          </div>
        </div>
        <div class="col-lg-2 col-md-3 col-sm-6 col-12">
          <div class="car_sports_category">
            <img src="assets/img/car/icon/icon-6.png" alt="img">
            <h4>Steering</h4>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-lg-4 col-md-6 col-sm-12 col-12">
          <div class="car_offers_banner">
            <img src="assets/img/car/common/offer-banner-1.png" alt="img">
          </div>
        </div>
        <div class="col-lg-4 col-md-6 col-sm-12 col-12">
          <div class="car_offers_banner">
            <img src="assets/img/car/common/offer-banner-2.png" alt="img">
          </div>
        </div>
        <div class="col-lg-4 col-md-6 col-sm-12 col-12">
          <div class="car_offers_banner">
            <img src="assets/img/car/common/offer-banner-3.png" alt="img">
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="car_full_img_banner">
            <a href="shop-3.html"><img src="assets/img/car/common/full-banner.png" alt="img"></a>
          </div>
        </div>
      </div>
    </div>
  ...
  <!-- best_selling_product_car Area  -->
  <section id="best_selling_product_car" class="pb-100">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <div class="car_area_main_heading">
            <h2><span>BEST SELLING</span> PRODUCTS</h2>
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-3 col-md-6 col-sm-12 col-12">
          <div class="product_item_two">
            ...
            <div class="product_detail">
              <h5 class="product_title">
                <a href="product_detail.html">Et lare sit id ut dolor ea irure</a>
              </h5>
              <p class="item_price">$39.00</p>
            </div>
          </div>
        ...
        <div class="col-lg-3 col-md-6 col-sm-12 col-12">
          <div class="product_item_two">
            ...
            <div class="product_detail">
              <h5 class="product_title">
                <a href="product_detail.html">Reprehenderit occaecat min</a>
              </h5>
              <p class="item_price">$39.00</p>
            </div>
          </div>
        ...
        <div class="col-lg-3 col-md-6 col-sm-12 col-12">
          <div class="product_item_two">
            ...
            <div class="product_detail">
              <h5 class="product_title">
                <a href="product_detail.html">Duis pariatur aute ullamc</a>
              </h5>
              <p class="item_price">$39.00</p>
            </div>
          </div>
        ...
        <div class="col-lg-3 col-md-6 col-sm-12 col-12">
          <div class="product_item_two">
            ...
            <div class="product_detail">
              <h5 class="product_title">
                <a href="product_detail.html">Amet tempor consectetur</a>
              </h5>
              <p class="item_price">$39.00</p>
            </div>
          </div>
        ...
        <div class="col-lg-3 col-md-6 col-sm-12 col-12">
          <div class="product_item_two">
            <div class="product_item_inner">
              <div class="product_img_wrap">
                <a href="shop-left-sidebar.html">
                  <img src="assets/img/car/product/pro-5.png" alt="product_img">
                </a>
              </div>
              <div class="product_button">
                <a href="cart.html"><i class="fa fa-shopping-bag"></i></a>
        ...
        <div class="col-lg-3 col-md-6 col-sm-12 col-12">
          <div class="product_item_two">
            <div class="product_item_inner">
              <div class="product_img_wrap">
                <a href="shop-left-sidebar.html">
                  <img src="assets/img/car/product/pro-6.png" alt="product_img">
                </a>
              </div>
              <div class="product_button">
                <a href="cart.html"><i class="fa fa-shopping-bag"></i></a>
        ...
        <div class="col-lg-3 col-md-6 col-sm-12 col-12">
          <div class="product_item_two">
            <div class="product_item_inner">
              <div class="product_img_wrap">
                <a href="shop-left-sidebar.html">
                  <img src="assets/img/car/product/pro-7.png" alt="product_img">
                </a>
              </div>
              <div class="product_button">
                <a href="cart.html"><i class="fa fa-shopping-bag"></i></a>
        ...
        <div class="col-lg-3 col-md-6 col-sm-12 col-12">
          <div class="product_item_two">
            <div class="product_item_inner">
              <div class="product_img_wrap">
                <a href="shop-left-sidebar.html">
                  <img src="assets/img/car/product/pro-8.png" alt="product_img">
                </a>
              </div>
              <div class="product_button">
                <a href="cart.html"><i class="fa fa-shopping-bag"></i></a>
  ...
  <!-- Midal car banner -->
  <section id="middal_car_banner_two" class="pb-100">
    <div class="container">
      <div class="row">
        <div class="col-lg-4 col-md-6 col-sm-12 col-12">
          <div class="middal_car_img">
            <img src="assets/img/car/common/middel-1.png" alt="img">
          </div>
        </div>
        <div class="col-lg-8 col-md-6 col-sm-12 col-12">
          <div class="middal_car_img">
            <img src="assets/img/car/common/middel-2.png" alt="img">
          </div>
        </div>
      </div>
    </div>
   ...
   <!-- FEATURED PRODUCTS Area -->
   <section id="trending_product_main" class="pb-100 slider_arrows_one">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <div class="car_area_main_heading">
  ...
  <section id="instagram_area_one">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <div class="car_area_main_heading">
            <h2><span>FOLLOW US ON</span> INSTAGRAM</h2>
          </div>
        </div>
      </div>
        <div class="row">
            <div class="col-lg-12">
                <div class="instagram_post_slider insta_gram_padding owl-carousel owl-theme">
                    <div class="instgram_post">
                        <a href="#!">
                            <i class="fab fa-instagram"></i>
                            <img src="assets/img/car/insta/1.png" alt="img" />
                        </a>
                    </div>
                    <div class="instgram_post">
                        <a href="#!">
                            <i class="fab fa-instagram"></i>
                            <img src="assets/img/car/insta/2.png" alt="img" />
                        </a>
                    </div>
                    <div class="instgram_post">
                        <a href="#!">
                            <i class="fab fa-instagram"></i>
                            <img src="assets/img/car/insta/3.png" alt="img" />
                        </a>
                    </div>
                    <div class="instgram_post">
                        <a href="#!">
                            <i class="fab fa-instagram"></i>
                            <img src="assets/img/car/insta/4.png" alt="img" />
                        </a>
                    </div>
                    <div class="instgram_post">
                        <a href="#!">
                            <i class="fab fa-instagram"></i>
                            <img src="assets/img/car/insta/5.png" alt="img" />
                        </a>
                    </div>
                    <div class="instgram_post">
                        <a href="#!">
...
<!-- Mirrored from andit.co/projects/html/andshop/andshop_frontend/car.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Apr 2023 19:37:00 GMT -->
</html>