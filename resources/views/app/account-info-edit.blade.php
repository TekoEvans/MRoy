...
<!-- Mirrored from andit.co/projects/html/andshop/andshop_frontend/account-info-edit.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Apr 2023 19:38:47 GMT -->
<head>
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <!-- Title -->
    <title>Account Info Edit - AndShop</title>
    <!-- Bootstrap css -->
                ...
                <div class="col-lg-12">
                    <div class="common_banner_text">
                        ...
                        <ul>
                            ...
                            <li class="active">Account Info Edit</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="account_thumd">
                        <div class="account_thumb_img">
                            ...
                            <div class="fixed_icon"><input type="file"><i class="fas fa-camera"></i></div>
                        </div>
                ...
                <div class="col-lg-9">
                    <div class="account_setting">
                        ...
                        <form action="https://andit.co/projects/html/andshop/andshop_frontend/!#" id="account_info_form">
